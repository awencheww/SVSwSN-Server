...
Partial Class formLoadParty
    ...
    Private Sub InitializeComponent()
        ...
        'ColumnHeader1
        '
        Me.ColumnHeader1.Text = "PartyID"
        Me.ColumnHeader1.Width = 0
        '
        'ColumnHeader2
        '
        Me.ColumnHeader2.Text = "PartyCode"
        Me.ColumnHeader2.Width = 106
        '
        'ColumnHeader3
        '
        Me.ColumnHeader3.Text = "PartyNamel"
        ...
        Me.GroupBox1.Text = "Enter Party Name"
        '
        'txtBoxSearch
        '
