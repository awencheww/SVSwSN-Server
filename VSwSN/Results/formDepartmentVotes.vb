...
Public Class formDepartmentVotes
    Private totalvoters As Integer
    Private percent As Double

    Private Sub formDepartmentVotes_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        LoadDepartment()
        LoadGov()
        GetTotalVotes()
    End Sub
    ...
    Private Sub LoadDepartment()
        Try
            ...
            ToolStripLabelDepartment.DropDownItems.Clear()

            While sqlreader.Read = True
                ToolStripLabelDepartment.DropDownItems.Add(sqlreader("DeptName"))
            End While
...
#Region "GOVERNOR"
    Private Sub ListView1_SelectedIndexChanged(sender As System.Object, e As System.EventArgs) Handles ListViewGov.SelectedIndexChanged
        Try
            ...
            If sqlreader.Read = True Then
                ...
                'Formula to get the Percentage... Percentage=(total votes / total voters) * 100
    ...
    Private Sub LoadGov()
        Try
            query = "SELECT CandidateID, CONCAT(Lastname, ', ', Firstname, ' ', Middlename) as CanName,PartyName,PicFile,Votes FROM Candidate as C, Party as P, Positions as Po, voting_level as L WHERE L.LevelID = Po.LevelID AND C.PartyID = P.PartyID AND C.PositionID = Po.PositionID AND PositionName = 'Governor' AND LevelName = 'Department' AND DeptName='" & ToolStripLabelDepartment.DropDownItems.ToString & "'  ORDER BY Lastname, Firstname ASC "
            Connection()
            sqlcommand = New MySqlCommand(query, conn)
            sqlreader = sqlcommand.ExecuteReader
...
#Region "VICE-GOVERNOR"
    ...
    Private Sub LoadViceGov()
        Try
            query = "SELECT CandidateID, CONCAT(Lastname, ', ', Firstname, ' ', Middlename) as CanName,PartyName,PicFile,Votes FROM Candidate as C, Party as P, Positions as Po, voting_level as L WHERE L.LevelID = Po.LevelID AND C.PartyID = P.PartyID AND C.PositionID = Po.PositionID AND PositionName = 'Vice-Governor' AND LevelName = 'SSG Executive Branch'  ORDER BY Lastname, Firstname ASC "
            Connection()
            sqlcommand = New MySqlCommand(query, conn)
            sqlreader = sqlcommand.ExecuteReader
...
#Region "SECRETARY"
    ...
    Private Sub LoadSecretary()
        Try
            query = "SELECT CandidateID, CONCAT(Lastname, ', ', Firstname, ' ', Middlename) as CanName,PartyName,PicFile,Votes FROM Candidate as C, Party as P, Positions as Po, voting_level as L WHERE L.LevelID = Po.LevelID AND C.PartyID = P.PartyID AND C.PositionID = Po.PositionID AND PositionName = 'Secretary' AND LevelName = 'SSG Executive Branch'  ORDER BY Lastname, Firstname ASC "
            Connection()
            sqlcommand = New MySqlCommand(query, conn)
            sqlreader = sqlcommand.ExecuteReader
...
#Region "TREASURER"
    ...
    Private Sub LoadTreasurer()
        Try
            query = "SELECT CandidateID, CONCAT(Lastname, ', ', Firstname, ' ', Middlename) as CanName,PartyName,PicFile,Votes FROM Candidate as C, Party as P, Positions as Po, voting_level as L WHERE L.LevelID = Po.LevelID AND C.PartyID = P.PartyID AND C.PositionID = Po.PositionID AND PositionName = 'Treasurer' AND LevelName = 'SSG Executive Branch'  ORDER BY Lastname, Firstname ASC "
            Connection()
            sqlcommand = New MySqlCommand(query, conn)
            sqlreader = sqlcommand.ExecuteReader
...
#Region "BUSINESS MANAGER"
    ...
    Private Sub LoadBman()
        Try
            query = "SELECT CandidateID, CONCAT(Lastname, ', ', Firstname, ' ', Middlename) as CanName,PartyName,PicFile,Votes FROM Candidate as C, Party as P, Positions as Po, voting_level as L WHERE L.LevelID = Po.LevelID AND C.PartyID = P.PartyID AND C.PositionID = Po.PositionID AND PositionName = 'Business Manager' AND LevelName = 'SSG Executive Branch'  ORDER BY Lastname, Firstname ASC "
            Connection()
            sqlcommand = New MySqlCommand(query, conn)
            sqlreader = sqlcommand.ExecuteReader
...
#Region "AUDITOR"
    ...
    Private Sub LoadAuditor()
        Try
            query = "SELECT CandidateID, CONCAT(Lastname, ', ', Firstname, ' ', Middlename) as CanName,PartyName,PicFile,Votes FROM Candidate as C, Party as P, Positions as Po, voting_level as L WHERE L.LevelID = Po.LevelID AND C.PartyID = P.PartyID AND C.PositionID = Po.PositionID AND PositionName = 'Auditor' AND LevelName = 'SSG Executive Branch'  ORDER BY Lastname, Firstname ASC "
            Connection()
            sqlcommand = New MySqlCommand(query, conn)
            sqlreader = sqlcommand.ExecuteReader
...
#Region "PIO"
    ...
    Private Sub LoadPIO()
        Try
            query = "SELECT CandidateID, CONCAT(Lastname, ', ', Firstname, ' ', Middlename) as CanName,PartyName,PicFile,Votes FROM Candidate as C, Party as P, Positions as Po, voting_level as L WHERE L.LevelID = Po.LevelID AND C.PartyID = P.PartyID AND C.PositionID = Po.PositionID AND PositionName = 'PIO' AND LevelName = 'SSG Executive Branch'  ORDER BY Lastname, Firstname ASC "
            Connection()
            sqlcommand = New MySqlCommand(query, conn)
            sqlreader = sqlcommand.ExecuteReader
